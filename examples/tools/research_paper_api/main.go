// ABOUTME: Example application demonstrating the ResearchPaperAPI tool from go-flock
...
func main() {
	fmt.Println("===========================================")
	fmt.Println("   ResearchPaperAPI Tool Example")
	fmt.Println("===========================================")
	fmt.Println()

	// Create ResearchPaperAPI tool
	searchTool := tools.NewResearchPaperAPITool()
	...
	if err != nil {
		...
		if result, ok := result1.(*tools.ResearchPaperAPIResult); ok {
	...
	if err != nil {
		...
		if result, ok := result2.(*tools.ResearchPaperAPIResult); ok {
			// Show provider info
	...
	if err != nil {
		...
		if result, ok := result3.(*tools.ResearchPaperAPIResult); ok {
	...
	if err != nil {
		...
		if result, ok := result4.(*tools.ResearchPaperAPIResult); ok {
